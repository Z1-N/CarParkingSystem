...
volatile int available_spaces = 0;  // Start with empty parking spaces
int brightness = 3;
#define GREEN_LED GPIO_PIN_2   // Green LED for entry indication
#define RED_LED   GPIO_PIN_3   // Red LED for exit indication
...
int main(void)
{
  ...
  while (1)
  {
    /* USER CODE END WHILE */
    /* USER CODE BEGIN 3 */
    Display_FULL(brightness);
    Display_Number(available_spaces, brightness);
    Car_Entry();
    Car_Exit();
  /* USER CODE END 3 */
}}
